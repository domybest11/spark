...
private[spark] class BlockManager(
  ...
  def getHdfsWriter(
      ...
      sparkConf: SparkConf): HdfsBlockObjectWriter = {
    new HdfsBlockObjectWriter(serializerManager, serializerInstance,
    bufferSize, writeMetrics, blockId, path, hadoopConf: Configuration,
    sparkConf: SparkConf)
  }
