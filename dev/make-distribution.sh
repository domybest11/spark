...
BUILD_COMMAND=("$MVN" -o clean package -DskipTests $@)
...
wget -P "$SPARK_HOME"/assembly/target/scala*/jars/ http://cypress.bilibili.co/sdk/iceberg/iceberg-spark3-runtime-0.11.1-bili-0.2.jar
