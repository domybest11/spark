...
wget -P "$SPARK_HOME"/assembly/target/scala*/jars/ http://nexus.bilibili.co/content/repositories/releases/org/apache/iceberg/iceberg-spark3-runtime/0.11.1-bili-0.5.6/iceberg-spark3-runtime-0.11.1-bili-0.5.6.jar
