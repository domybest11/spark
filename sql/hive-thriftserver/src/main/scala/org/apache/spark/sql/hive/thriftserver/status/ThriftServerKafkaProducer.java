...
public class ThriftServerKafkaProducer {
    private SparkConf conf;
    private final static Logger LOGGER = LoggerFactory.getLogger(ThriftServerKafkaProducer.class);
    private KafkaProducer<String, byte[]> kafkaProducer;
    private Properties kafkaProps;
    private String METRIC_TOPIC = "lancer_bigdata_spark_spark";
    protected final ObjectMapper mapper = new ObjectMapper();

    public ThriftServerKafkaProducer() {

    }

    public ThriftServerKafkaProducer(SparkConf conf) {
    ...
    public void report(ThriftServerReportWrap thriftServerReportWrap) {
    ...
    private ProducerRecord<String, byte[]> convert2ProducerRecord(ThriftServerReportWrap thriftServerReportWrap)
