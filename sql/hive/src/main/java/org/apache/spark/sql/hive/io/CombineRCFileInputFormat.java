...
public class CombineRCFileInputFormat<K extends LongWritable, V extends BytesRefArrayWritable>
  ...
  public RecordReader<K, V> getRecordReader(InputSplit split,
    ...
    return new CombineFileRecordReader(jobConf,(CombineFileSplit)split, reporter,
        RCFileRecordReaderWrapper.class);
  }

  private static class RCFileRecordReaderWrapper<K extends LongWritable, V extends BytesRefArrayWritable>
    ...
    public RCFileRecordReaderWrapper(CombineFileSplit split, Configuration conf,
      ...
      super(new RCFileInputFormat<>(), split, conf, reporter, idx);
    }
  }
}
