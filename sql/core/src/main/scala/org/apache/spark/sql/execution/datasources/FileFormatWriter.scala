...
object FileFormatWriter extends Logging {
  ...
  def writerPartitionHiveTableRDD(
      sparkSession: SparkSession,
      rdd: RDD[InternalRow],
      fileFormat: FileFormat,
  ...
  private def executeTask4SpecCommitter(
    ...
    val committer = partitionCommitterMap(sparkPartitionId)._1
    val finalPath = partitionCommitterMap(sparkPartitionId)._2
    ...
    val taskAttemptContext: TaskAttemptContext = {
      ...
      hadoopConf.set("mapreduce.output.fileoutputformat.outputdir", finalPath)
